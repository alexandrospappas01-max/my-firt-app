...
st.markdown(
    """
    <style>
    /* Ανεβάζουμε όλη την εφαρμογή μαζί μία γραμμή πάνω (από 4.5 σε 3.5) */
    .block-container {
        padding-top: 3.5rem; 
        padding-bottom: 5rem;
    }
    ...
    /* Programmed by: Παραμένει στη θέση του */
    .footer {
        position: fixed;
        left: 0;
        bottom: 60px; 
...
def get_mathimata(mera_idx):
    schedule = {
        ...
        2: ["Μαθηματικά", "Πλoροφορική", "Βιολογία", "Γεωμετρία", "Εργαστήρια", "Οικ. Οικ.", "Θρησκευτικά"],
